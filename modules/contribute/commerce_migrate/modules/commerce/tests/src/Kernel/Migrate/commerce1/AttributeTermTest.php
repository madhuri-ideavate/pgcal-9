...
class AttributeTermTest extends Commerce1TestBase {
  ...
  public function testMigrateProductAttributeValueTest() {
    ...
    $this->assertProductAttributeValueEntity('4', 'storage_capacity_with_very_lon', '8GB', '8GB', '0');
    $this->assertProductAttributeValueEntity('5', 'storage_capacity_with_very_lon', '16GB', '16GB', '1');
    $this->assertProductAttributeValueEntity('6', 'storage_capacity_with_very_lon', '32GB', '32GB', '2');
